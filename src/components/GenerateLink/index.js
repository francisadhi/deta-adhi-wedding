...
function GenerateLink() {
  ...
  const URL = `https://adhideta.herokuapp.com?to=${encodeURIComponent(name)}`;
            ...
            <table class="table">
              ...
              <tbody>
                {data.map((d, index) => {
                  ...
                  const mapURL = `https://adhideta.herokuapp.com?to=${encodeURIComponent(d.name)}${offlineInvitation}`;
                  return (
                    <tr>
                      <td>{index + 1}</td>
                      <td>{d.name}</td>
